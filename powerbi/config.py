"""
Configuration for the Power BI Newsletter Agent.

Reads from POWERBI_* environment variables, falling back to the general
...
EEEZ_TITLE_FILTER = os.environ.get("POWERBI_EEEZ_TITLE_FILTER",
...
CSS_FEEDBACK_QUERY_ID = os.environ.get("POWERBI_CSS_FEEDBACK_QUERY_ID",
...
CSS_TAXONOMY_QUERY_ID = os.environ.get("POWERBI_CSS_TAXONOMY_QUERY_ID",
                                       os.environ.get("CSS_TAXONOMY_QUERY_ID", ""))

# ── Hot Topics ──────────────────────────────────────────────────────
HOT_TOPICS_FOLDER = os.environ.get(
    "POWERBI_HOT_TOPICS_FOLDER",
...
EMAIL_RECIPIENTS = os.environ.get("POWERBI_EMAIL_RECIPIENTS",
                                  os.environ.get("EMAIL_RECIPIENTS", "team@yourdomain.com"))
EMAIL_SUBJECT_PREFIX = os.environ.get("POWERBI_EMAIL_SUBJECT_PREFIX",
                                      os.environ.get("EMAIL_SUBJECT_PREFIX", "Power BI Newsletter"))
POWER_AUTOMATE_WEBHOOK_URL = os.environ.get("POWER_AUTOMATE_WEBHOOK_URL", "")

# ── Static Content ──────────────────────────────────────────────────
VTEAM_MD_FILE = os.environ.get(
    "POWERBI_VTEAM_MD_FILE",
    os.environ.get(
        "VTEAM_MD_FILE",
