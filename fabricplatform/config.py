"""
Configuration for the Fabric Platform Newsletter Agent.

Reads from FABRICPLATFORM_* environment variables, falling back to the general
...
TSG_WIKI_FOLDER = os.environ.get(
    "FABRICPLATFORM_TSG_WIKI_FOLDER",
    "/Fabric Platform",
)
...
EEEZ_TITLE_FILTER = os.environ.get("FABRICPLATFORM_EEEZ_TITLE_FILTER",
                                    os.environ.get("EEEZ_TITLE_FILTER", "NF-PLAT"))
EEEZ_YEAR = os.environ.get("EEEZ_YEAR", "")
EEEZ_MONTH = os.environ.get("EEEZ_MONTH", "")

# ── CSS Feedback (different ADO org) ────────────────────────────────
CSS_FEEDBACK_QUERY_ID = os.environ.get("FABRICPLATFORM_CSS_FEEDBACK_QUERY_ID",
...
CSS_TAXONOMY_QUERY_ID = os.environ.get("FABRICPLATFORM_CSS_TAXONOMY_QUERY_ID",
                                       os.environ.get("CSS_TAXONOMY_QUERY_ID", ""))

# ── Hot Topics ──────────────────────────────────────────────────────
HOT_TOPICS_FOLDER = os.environ.get(
    "FABRICPLATFORM_HOT_TOPICS_FOLDER",
...
EMAIL_RECIPIENTS = os.environ.get("FABRICPLATFORM_EMAIL_RECIPIENTS",
                                  os.environ.get("EMAIL_RECIPIENTS", "team@yourdomain.com"))
EMAIL_SUBJECT_PREFIX = os.environ.get("FABRICPLATFORM_EMAIL_SUBJECT_PREFIX",
                                      os.environ.get("EMAIL_SUBJECT_PREFIX", "Fabric Platform Newsletter"))
POWER_AUTOMATE_WEBHOOK_URL = os.environ.get("POWER_AUTOMATE_WEBHOOK_URL", "")

# ── Static Content ──────────────────────────────────────────────────
VTEAM_MD_FILE = os.environ.get(
    "FABRICPLATFORM_VTEAM_MD_FILE",
    os.path.join(os.path.dirname(os.path.dirname(__file__)),
                 "config", "Fabric Platform Component V-Team.md"),
)
